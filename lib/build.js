...
const buildAct = config => ({act, oog, pass, name, hasGas, gas, lemma}) => {
  ...
  const buildAccount = varname => {
   ...
   // When that happens, claims about gas for this storage locatoin won't be completely accurate.
   // This could be solved by this value symbolic, which it how it used to be.
