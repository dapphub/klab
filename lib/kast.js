...
const format = (o, isRaw = false, mixFix = false, colorize = false) => {
  if(o.node == KVARIABLE) {
    ...
    const pt = {
      ...
      "115792089237316195423570985008687907853269984665640564039457584007913129639680": "maxUInt256 - 255",
    ...
    let tokenMap = {
      ...
      ".List{\"intList\"}": "",
      ".WordStack_EVM-DATA": "",
      "#WordPackUInt112UInt112UInt32(_,_,_)_RULES": "#WordPackUInt112UInt112UInt32",
      "_[_:=_]_EVM-DATA": "EVM-DATA",
    }
