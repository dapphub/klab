...
const controlObject = {
  ...
  "scroll_down": (state, args) => {
    return {
      ...state,
      scroll: (state.scroll||0) + 1
    }
  },
  "scroll_up": (state, args) => {
    return {
      ...state,
      scroll: Math.max((state.scroll||0) - 1, 0)
    }
  },
  "page_down": (state, args) => {
    return {
      ...state,
      scroll: (state.scroll||0) + 20
    }
  },
  "page_up": (state, args) => {
    return {
      ...state,
      scroll: Math.max((state.scroll||0) - 20, 0)
    }
  },
  "home": (state, args) => {
    return {
