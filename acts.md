...
rule A => C
    ...
    ensures D
```
However, when `A` and `C` both express configurations describing the entire state relevant to an ethereum contract, such an expression can get quite [large](https://github.com/dapphub/k-dss/blob/6d536c91a407fd3ead44b9347e25b6790663a10a/out/specs/Vat_tune_succ.k).
